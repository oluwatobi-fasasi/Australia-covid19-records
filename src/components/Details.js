              ...
              {data.map((item) => (
                ...
                <div key={item.region} className=" text-white bg-green-700 border-4 py-14 px-10">
                  <li className="flex flex-col">
                    <p className="text-6xl pt-2 self-center md:text-3xl">
                      Region:
                      <span className="pl-3 text-6xl font-bold md:text-4xl">{item.region}</span>
                    </p>
                    <p className="pt-10 text-5xl self-center">
                      Total number of death:
                      <span className="pl-3 font-bold">{item.deaths['2020-08-08'].total}</span>
